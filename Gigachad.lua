...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì Gigachad Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : Update.. <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Night Hub", HidePremium = false, IntroText = "Gigachad Library", SaveConfig = true, ConfigFolder = "Gigachad Hub"})
...
OrionLib:MakeNotification({
	Name = "Gigachad Hub",
	Content = "Gigachad Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By Phuc")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Gigachad Hub is back!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Gigachad Hub(Noitification)",
